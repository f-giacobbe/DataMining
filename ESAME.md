Esame scritto in laboratorio (1 ora, 3 esercizi: data exploration + allenare algoritmo di clustering; classificazione/regressione; solo allenamento di rete neurale). Si ha un jupyter notebook “svolto” dove però mancano parti.
